...
include('session.php');
						...
						$q= "select  * from meritlist order by meritid asc limit $start_from, $record_per_page ";
...
<head>
    ...
    <title>Update Or Delete Merit List</title>
    ...
    <section id="intro" class="intro">
		<div class="container ">
			<div class="col-lg-12">
				<br><br>
				 ...
				 <table class="table table-stripped table-hover table-bordered">
				 	...
				 	<tr class="text-center">
				 		...
				 		<td><?php echo $res['gmr']; ?></td>
				 		<td><?php echo $res['scrank']; ?></td>
				 		<td><?php echo $res['strank']; ?></td>
				 		<td><?php echo $res['pcrank']; ?></td>


				  		<td><button class="btn-success btn "><a href="meritlistupdate.php?meritid=<?php echo $res['meritid']; ?>" class="text-white"> Update</a></button></td>
				 		<td><button class="btn-danger btn "><a href="meritlistdelete.php?meritid=<?php echo $res['meritid']; ?>" class="text-white"> Delete</a></button> </td>
    			...
    			<br />
   				 <?php
   				 $page_query = "SELECT * FROM meritlist ORDER BY meritid DESC";
    			...
    			for($i=1;$i<=$total_records;$i++)
   				 {
    				  echo '<a class="anchor" href="updateordeletemeritlist.php?page='.$i.'">'.$i.'</a>';
    			}
