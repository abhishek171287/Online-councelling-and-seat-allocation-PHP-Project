...
<head>
    ...
    <title>UPDATE OR DELETE COUNCELLING STUDENTS</title>
			...
			<div class="col-lg-12">
				<br><br>
				 <br>
				 	...
				 	<tr>
				 		<td class="text-center"><h1 class="text-warning text-center"> COUNCELLING STUDENTS</h1></td>
				 	</tr>
				 </table>
				 <table class="table table-stripped table-hover table-bordered">
				 	<tr class=" text-center">
				 		<th class=" text-center" bgcolor="BLUEVIOLET">Application ID</th>
				 		<th class=" text-center" bgcolor="FUCHSIA">Roll No</th>
				 		<th class=" text-center" bgcolor="CRIMSON">Candidate Name</th>
				 		<th class=" text-center" bgcolor="RED">D.O.B.(YYYY-MM-DD)</th>
				 		<th class="text-center" bgcolor="LIGHTGREEN">Rank</th>
				 		<th class=" text-center" bgcolor="CYAN">Institute Alloted</th>
				 		<th class="text-center" bgcolor="GOLD">Aadhar Number</th>
				 		<th class=" text-center" bgcolor="CRIMSON">E-Mail</th>
				 		<th class=" text-center" bgcolor="YELLOW">Mobile</th>
				 		<th class=" text-center" bgcolor="POWERBLUE">Bank</th>
				 		<th class=" text-center" bgcolor="PLUM">Chalan</th>
    			...
    			for($i=1;$i<=$total_records;$i++)
   				 {
    				  echo '<a class="anchor" href="councellingstudents.php?page='.$i.'">'.$i.'</a>';
    			}
