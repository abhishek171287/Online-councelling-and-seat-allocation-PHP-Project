...
if(isset($_POST['Submit']))
{
	...
	$sql2="SELECT * FROM participatingcollege WHERE collegename='$college' "; 
	...
	$sql1="SELECT * FROM participatingcollege WHERE website='$website' "; 
            ...
            if($count1>0) 
      {
		...
		echo "alert('College Already exists');";
		echo "</script>";
      }
      ...
      {
		$sql =" update participatingcollege set collegeid=$id,collegename='$college',openingrank='$orank' ,
			closingrank='$crank',website='$website' where collegeid=$id ";
...
<head>
    ...
    <title>UPDATE PARTICIPATING INSTITUTES</title>
					...
					<div >
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> UPDATE PARTICIPATING COLLEGES </h3>
									</div>
									<div class="panel-body">
									<form name="myform" id="myform" action="" method="post" role="form" class="lead"  onsubmit="return validate1()">
										<div class="row">
											<div >
