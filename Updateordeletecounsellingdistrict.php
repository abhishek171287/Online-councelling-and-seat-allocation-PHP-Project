...
include('session.php');
						...
						$start_from = ($page-1)*$record_per_page;
				 		...
				 		$q= "select  * from examdistrict order by DistrictID asc limit $start_from, $record_per_page ";
...
<head>
    ...
    <title>UPDATE OR DELETE COUNCELLING DISTRICTS</title>
...
<div id="wrapper">
    ...
    <section id="intro" class="intro">
		<div class="container ">
			<div class="col-lg-12">
				<br><br>
				<h1 class="text-warning text-center">Diplay Counselling Districts</h1>	
				 <br>
				  <table>
				 	...
				 	<tr>
				 		<td class="text-center"><h1 class="text-warning text-center"> COUNCELLING DISTRICTS</h1></td>
				 	</tr>
				 </table>
				 <table class="table table-stripped table-hover table-bordered">
				 	<tr class=" text-center">
				 		<th class=" text-center" bgcolor="BLUEVIOLET">ID</th>
				 		<th class=" text-center" bgcolor="FUCHSIA">Counselling Districts</th>
				  		<th class=" text-center" bgcolor="DARKCYAN">Update</th>
				 		<th class=" text-center" bgcolor="TAN">Delete</th>
				 	...
				 	<tr class="text-center">
				 		<td><?php echo $res['DistrictID']; ?></td>
				 		<td><?php echo $res['ExamDistrict']; ?></td>
				  		<td><button class="btn-primary btn "><a href="districtupdate.php?DistrictID=<?php echo $res['DistrictID']; ?>" class="text-white"> Update</a></button></td>
				 		<td><button class="btn-danger btn "><a href="districtdelete.php?DistrictID=<?php echo $res['DistrictID']; ?>" class="text-white"> Delete</a></button> </td>
    			...
    			<br />
   				 <?php
   				 $page_query = "SELECT * FROM examdistrict ORDER BY DistrictID DESC";
    			...
    			for($i=1;$i<=$total_records;$i++)
   				 {
    				  echo '<a class="anchor" href="Updateordeletecounsellingdistrict.php?page='.$i. '">'.$i. '</a>';
    			}
