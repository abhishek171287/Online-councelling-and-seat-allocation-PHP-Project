...
if(isset($_POST['Submit']))
	{
		...
		$sql ="update meritlist set name='$name',dob='$dob',gender='$gender',cat='$cat',pc='$pc',gmr='$gmr',scrank='$scrank',strank='$strank',pcrank='$pcrank' where meritid=$id ";
		...
		header("Location:meritlistupdate.php");
					...
					<div >
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> UPDATE STUDENT OF MERIT LIST </h3>
									</div>
