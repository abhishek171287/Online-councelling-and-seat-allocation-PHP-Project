<?php
				 include('session.php');
						...
						$q= "select  * from councellingcities order by cityid asc limit $start_from, $record_per_page ";
			...
			<div class="col-lg-12">
				<br><br>
				 <br>
				 	...
				 	<tr>
				 		<td class="text-center"><h1 class="text-warning text-center"> COUNCELLING CITIES</h1></td>
				 	</tr>
				 </table>
				 <table class="table table-stripped table-hover table-bordered">
				 	<tr class=" text-center">
				 		<th class=" text-center" bgcolor="BLUEVIOLET">ID</th>
				 		<th class=" text-center" bgcolor="FUCHSIA">Counselling Cities</th>
				 		<th class=" text-center" bgcolor="CRIMSON">Counselling Districts</th>
				 	...
				 	<tr class="text-center">
				 		...
				 		<td><?php echo $res['district']; ?></td>
				  		...
				  		<td><button class="btn-success btn "><a href="citiesupdate.php?cityid=<?php echo $res['cityid']; ?>" class="text-white"> Update</a></button></td>
				 		<td><button class="btn-danger btn "><a href="citiesdelete.php?cityid=<?php echo $res['cityid']; ?>" class="text-white"> Delete</a></button> </td>
    			...
    			<br />
   				 <?php
   				 $page_query = "SELECT * FROM councellingcities ORDER BY cityid DESC";
    			...
    			for($i=1;$i<=$total_records;$i++)
   				 {
    				  echo '<a class="anchor" href="Updateordeletecounsellingcities.php?page='.$i.'">'.$i.'</a>';
    			}
