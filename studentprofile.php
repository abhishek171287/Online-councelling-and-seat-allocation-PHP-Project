...
include('session.php');
				 ...
				 $applicationid=$_SESSION['login_user'];
						$q= "SELECT * FROM councellingstudents WHERE applicationid='$applicationid'" ;
				 		$query=mysqli_query($con,$q);
				 		
				 		

$error="WELCOME APPLICATION ID:".$_SESSION['login_user'];
    ...
    <section id="intro" class="intro">
		<div class="container ">
			<div class="col-lg-12">
				...
				<br><br>
				<br><br>
				<h1 class="text-warning text-center">Your Submitted details</h1>	
				 <br>
				 <table class="table table-stripped table-hover table-bordered">
				 	<tr class=" text-center">
				 		...
				 		<th class=" text-center" bgcolor="DARKSEAGREEN">Rank</th>
