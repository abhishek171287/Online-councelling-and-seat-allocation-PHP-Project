...
{
	$id= $_GET['DistrictID'];
	$District= $_POST ['ExamDistrict'];

		$sql =" update examdistrict set DistrictID=$id,ExamDistrict='$District'  where DistrictID=$id ";
...
<head>
	...
	function validation()
    {
         ...
         if(district=="")
        {
         ...
         if(district.match(correct))
        return true;
        else
        {
        alert("District Name Can only have characters");
            return false;
        }
	}
	</script>
					...
					<div >
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> UPDATE COUNSELLING DISTRICT </h3>
									</div>
									<div class="panel-body">
									<form  action="" method="post" role="form" class="lead" onsubmit="validation()">
										<div class="row">
											<div >
												<div class="form-group">
													<label>ENTER COUNSELLING DISTRICT OF WEST BENGAL</label>
													<input type="text" name="ExamDistrict" id="district" class="form-control input-md" required="">
												</div>
											</div>
