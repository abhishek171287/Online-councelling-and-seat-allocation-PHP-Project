...
if(isset($_POST['Submit']))
{
	...
	$sql1="SELECT * meritlist WHERE rollno='$rollno'";
	$res1=mysqli_query($con,$sql1);

		$sql =" INSERT INTO allocate WHERE rollno=$rollno,rollno='$rollno',college='$college'";
		if(!mysqli_query($con,$sql))
		{
		echo "<script language='javascript' type='text/javascript'>";
		echo "alert('student is not updated');";
		echo "</script>";
		}
					...
					<div >
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> ALLOCATE YOUR SEAT </h3>
									</div>
									...
									<form  action="" method="post" role="form" class="lead">
										<div class="row">
											<div >
  											...
  											<label>INSTITUTE AVAILABLE TO YOU:</label>
											<select name="districtselected" required="">
										<option selected="---"><----INSTITUTE---></option>
												<?php
									$res=mysqli_query($link,"select  * from participatingcollege  WHERE openingrank>10 AND closingrank<5000");
