...
<div id="wrapper">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">	<li class="active"><a href="adminhome.html">Home</a></li>
		...
		<div class="intro-content">
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">WBJECA ADMIN SECTION</h2>
					</div>
					<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.1s">
					<h4 class="h-light"><span class="color"><h1 align='center'>Welcome ADMIN  </h1> 
     </span></h4>
					</div>
    ...
    <div class="ticker-wrap">
      <div class="ticker-move">
        <div class="ticker-item">Joint Entrance Examination for admissions to Master of Computer Applications (JECA), is conducted by West Bengal Joint Entrance Examination Board (WBJEEB).</div>
        <div class="ticker-item">The exam is a gateway for admissions to MCA courses offered by colleges in the state of West Bengal.</div>
        <div class="ticker-item">This year, WBJECA 2019 is scheduled for July 13, 2019.</div>
