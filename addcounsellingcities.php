...
<head>
    ...
    <title>ADD COUNSELLING CITIES</title>
					...
					<div >
						<div class="form-wrapper">
							...
							<div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span> ADD COUNSELLING CITIES </h3>
									</div>
									<div class="panel-body">
									<form  action="addcounsellingcities1.php" method="post" role="form" class="lead" onSubmit="return validation()">
										<div class="row" > 
											<div >
												<div class="form-group">
													<label>SELECT COUNSELLING DISTRICT OF WEST BENGAL:</label>
											<select name="districtselected"  required="">
										<option selected="---" hidden ><----ExamDistrict---></option>
												<?php
									$res=mysqli_query($link,"select distinct * from examdistrict Order By examdistrict ASC");
									...
									while($row=mysqli_fetch_array($res))
									{
										...
										?>
												...
												<option><?php echo $row["ExamDistrict"] ; ?></option> 
										<?php
									}
										?>
											</select>	
										</div>	
												<label>		ENTER COUNSELLING CITY OF THE DISTRICT:</label>
										...
										<input type="submit" name="Submit" value="Submit" class="btn btn-skin btn-block btn-lg">
