...
include('session.php');
						...
						$q= "select  * from participatingcollege order by collegeid asc limit $start_from, $record_per_page ";
...
<head>
    ...
    <title>Update Or Delete Colleges</title>
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
			...
			<div class="col-lg-12">
				<br><br>
				 ...
				 <table>
				 	...
				 	<tr>
				 		<td class="text-center"><h1 class="text-warning text-center"> Participating Colleges and Universities</h1></td>
				 	</tr>
				 </table>
				 <table class="table table-stripped table-hover table-bordered ">
				 	...
				 	<tr class=" text-center">
				 		...
				 		<th class=" text-center" bgcolor="CRIMSON">Opening Rank</th>
				 			...
				 			<th class=" text-center" bgcolor="GOLD">Seats available</th>
				  		<th  class=" text-center" bgcolor="FUCHSIA">Update</th>
				 		<th class=" text-center" bgcolor="OLIVE">Delete</th>
				 	...
				 	<tr class="text-center">
				 		...
				 		<td><?php echo $res['openingrank']; ?></td>
				 		<td><?php echo $res['closingrank']; ?></td>
				 		<td><?php echo $res['website']; ?></td>
				 		<td><?php echo $res['seats']; ?></td>
				  		<td><button class="btn-success btn "><a href="collegeupdate.php?collegeid=<?php echo $res['collegeid']; ?>" class="text-white"> Update</a></button></td>
				 		<td><button class="btn-danger btn "><a href="collegedelete.php?collegeid=<?php echo $res['collegeid']; ?>" class="text-white"> Delete</a></button> </td>
				 	</tr>
    ...
    <br />
    <?php
    $page_query = "SELECT * FROM participatingcollege ORDER BY collegeid DESC";
    ...
    {
      echo '<a class="anchor" href="updateordeletecolleges.php?page='.$i.'">'.$i.'</a>';
    }
